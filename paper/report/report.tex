...
5cm, and that since it is based on a dipole, the total length of the two elements should be ½ wavelength, thus 13.
75cm, and with each element being the same length, we know that each element should be ¼ wavelength or 6.
